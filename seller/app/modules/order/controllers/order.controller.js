...
class OrderController {
    ...
    async updateOrderStatus(req, res, next) {
        try {
            const params = req.params;
            const product = await orderService.updateOrderStatus(
                params.orderId,
                req.body
            );
            return res.send(product);
    ...
    async ondcUpdate(req, res, next) {
        try {
            const params = req.params;
            const product = await orderService.OndcUpdate(
                params.orderId,
                req.body
            );
            return res.send(product);
    ...
    async cancelOrder(req, res, next) {
        try {
            const params = req.params;
            const product = await orderService.cancelOrder(
                params.orderId,
                req.body
            );
            return res.send(product);
    ...
    async cancelItems(req, res, next) {
        try {
            try {
                const params = req.params;
                const product = await orderService.cancelItems(
                    params.orderId,
                    req.body
                );
                return res.send(product);
    ...
    async updateReturnItem(req, res, next) {
        try {
            try {
                const params = req.params;
                const product = await orderService.updateReturnItem(
                    params.orderId,
                    req.body
                );
                return res.send(product);
